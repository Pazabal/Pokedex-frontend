...
const Inicio = () => {
const login = () => {
  fetch('http://localhost:4000/login', {method:'POST', headers:{'Content-Type': 'application/json', 'Accept': 'application/json'}, mode:'no-cors', body:JSON.stringify({name:nombre, password:password})})
  .then((res) => {
    console.log(res)
  })
}
        ...
        <div className='md:w-1/2 w-[390px] h-screen bg-white flex flex-col items-center justify-center'>
          ...
          <div className='flex flex-col w-[80%] md:w-full items-center justify-center'>
            <div className='w-[90%] md:w-1/2'>
              ...
              <input type='text' onChange={(e) => {setNombre(e.target.value)}} placeholder='ingrese su nombre' className='w-full md:w-[500px] pl-[20px] bg-[#f7f7f9] mt-[10px] mb-[50px] rounded-xl py-[5px] shadow-md hover:shadow-xl'></input>
            </div>
            <div className='w-[90%] md:w-1/2'>
